...
namespace nosjob {
    ...
    */
    ...
    /**
       ...
       takes one argument of type AtomType_::ValueType.
    */
    template <typename AtomType_>
    ...
    */
    ...
    struct NativeToAtom< std::pair<FirstT, SecondT > >
    {
        ...
        {
            static const Utf8String str1("k");
            static const Utf8String str2("v");
            Object obj;
    ...
    */
    ...
    struct AtomToNative_list_base
    {
        ...
        */
        ...
        /**
           Unfortunate overload required to handle certain
           conversions, but is only typesafe at runtime, not
           compile-time. Throws if the argument is-not-a Object.
        */
        inline ReturnType operator()( Atom const & ar ) const{
...
//         }
    ...
    struct AtomToNative_map_base
    {
        typedef MapType ReturnType;
        /**
           Converts ar to a std::map. ar must have been serialized with
           NativeToAtom_map_base.
        */
        inline ReturnType operator()( Array const & ar ) const
        {
            MapType rc;
            ...
            for( ; it != et; ++it ){
                ...
                if( Object::isObject(v) ) {
                    rc.insert( atomToNative< typename MapType::value_type >(v) );
                }
                else {
        ...
        /**
           Unfortunate overload required to handle certain
           conversions, but is only typesafe at runtime, not
           compile-time. Throws if the argument is-not-a Array.
        */
        inline ReturnType operator()( Atom const & ar ) const{
            return this->operator()( Array::cast(ar) );
        }
    };
