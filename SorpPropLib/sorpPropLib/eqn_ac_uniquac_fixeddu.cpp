...
double eqn_ac_UNIQUAC_fixedDu::calc(DATAMAP& pairs,const parms prms, double tK, double xMass, std::vector<double> refInfo)
{
    para_UNIQUAC_fixedDu mpara(prms);

    double x1 = xMass, x2 = 1 - xMass;
	double du12 = mpara.du12;
	double du21 = mpara.du21;
