...
double eqn_dubininastakov_mass::calc(const parms prms, double tK, double xMass, std::string ref)
{
...
double eqn_dubininastakov_mass::calcY(const para_dubininastakov_mass& para, double tK, double pKpa)
{
	double rho = 0.5;
	double Ps = 1;
	double R = 8.314;
