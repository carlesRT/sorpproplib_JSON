...
function dp_dw_wT
  ...
  // Function call
  //
  external"C" dp_dw = direct_ads_sur_dp_dw_wT(w, T, path_db,
...
<p>Calculates derivative of equilibrium pressure p with respect to loading w in kgPa/kg depending on equilibrium loading w in kg/kg and equilibrium temperature T in K.</p>
</html>"));
end dp_dw_wT;
