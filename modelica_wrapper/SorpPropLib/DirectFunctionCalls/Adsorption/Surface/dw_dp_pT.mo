...
function dw_dp_pT
  ...
  // Function call
  //
  external"C" dw_dp = direct_ads_sur_dw_dp_pT(p, T, path_db,
...
<p>Calculates derivative of equilibrium loading w with respect to pressure p in kg/kg/Pa depending on equilibrium pressure p in Pa and equilibrium temperature T in K.</p>
</html>"));
end dw_dp_pT;
