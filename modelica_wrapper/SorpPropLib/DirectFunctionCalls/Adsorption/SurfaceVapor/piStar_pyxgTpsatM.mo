...
function piStar_pyxgTpsatM "Calculates reduced spreading pressure depending on total pressure, molar 
  ...
  // Function call
  //
  external"C" piStar = direct_ads_sur_piStar_pyxgTpsatM(
    p_total, y, x, g, T, p_sat, M, path_db,
