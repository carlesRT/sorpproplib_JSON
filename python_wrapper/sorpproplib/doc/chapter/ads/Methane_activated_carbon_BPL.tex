%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Chapter 'Adsorption - Methane - activated carbon BPL'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Activated carbon BPL}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Surface area & \si{\square\meter\per\gram} & 1150\\
Pore volume & \si{\milli\cubic\meter\per\gram} & 0.43\\
...
flag & - & 1.000000000e+00 & $n$ & - & 1.540000000e+00 \\
$E$ & $\si{\joule\per\mole}$ & 7.040000000e+03 & $W_0$ & $\si{\cubic\meter\per\kilogram}$ & 3.600000000e-04 \\

\addlinespace\end{longtable}

\textbf{Validity:}
\newline
Equation is approximately valid for $273.0 \si{\kelvin} \leq T \leq 333.0 \si{\kelvin}$.
\newline
