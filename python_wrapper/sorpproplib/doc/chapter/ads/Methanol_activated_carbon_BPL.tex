%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Chapter 'Adsorption - Methanol - activated carbon BPL'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
$E$ & $\si{\joule\per\mole}$ & 6.700000000e+03 & $W_0$ & $\si{\cubic\meter\per\kilogram}$ & 4.140000000e-04 \\

\addlinespace\end{longtable}

\textbf{Validity:}
\newline
Equation is approximately valid for $311.15 \si{\kelvin} \leq T \leq 400.15 \si{\kelvin}$.
\newline
