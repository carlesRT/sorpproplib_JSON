%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Chapter 'Absorption - Benzene - inoic liquid [MMIM]+[(CFH3SO2)2N]-'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
$a_{12}$ & $\si{\joule\per\mole}$ & -6.099440000e+04 & $a_{21}$ & $\si{\joule\per\mole}$ & -5.319100000e+03 \\
$b_{12}$ & $\si{\joule\per\mole\per\kelvin}$ & -3.409200000e+02 & $b_{21}$ & $\si{\joule\per\mole\per\kelvin}$ & 1.510000000e+01 \\
...
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/abs/abs_Benzene_inoic_liquid_[MMIM]+[(CFH3SO2)2N]-_NrtlTemperatureDg_1.pdf}}
\end{figure}
%
...
The mean absolute percentage error (MAPE) between the experimental and calculated data results in 23.96\%.
\FloatBarrier
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
