%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Chapter 'Absorption - R-123 - lubricant MO56'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Lubricant MO56}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
$T_\mathrm{crit,1}$ & $\si{\kelvin}$ & 4.568300000e+02 & $T_\mathrm{crit,2}$ & $\si{\kelvin}$ & 8.320000000e+02 \\
$p_\mathrm{crit,1}$ & $\si{\pascal}$ & 3.668000000e+06 & $p_\mathrm{crit,2}$ & $\si{\pascal}$ & 1.104000000e+06 \\
$\omega_{1}$ & - & 0.000000000e+00 & $\omega_{2}$ & - & 0.000000000e+00 \\
$\kappa_{1,1}$ & - & 0.000000000e+00 & $\kappa_{1,2}$ & - & 0.000000000e+00 \\
$\beta_{0,1}$ & - & 1.001600000e+00 & $\beta_{0,2}$ & - & 1.000000000e+00 \\
$\beta_{1,1}$ & - & 4.792500000e-01 & $\beta_{1,2}$ & - & 1.020000000e+00 \\
$\beta_{2,1}$ & - & -7.111000000e-02 & $\beta_{2,2}$ & - & 0.000000000e+00 \\
$\beta_{3,1}$ & - & 1.580000000e-02 & $\beta_{3,2}$ & - & 0.000000000e+00 \\
$k_{12}$ & - & 0.000000000e+00 & $m$ & - & -4.800000000e-02 \\
$l_{12}$ & - & 3.840000000e-02 & $l_{21}$ & - & 3.840000000e-02 \\
$t$ & - & 7.580000000e+00 & & & \\
