%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Chapter 'Absorption - Acetone - ionic liquid [EMIM]+[(CF3SO2)2N]-'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
$\alpha_{12}$ & - & 4.700000000e-01 & $\alpha_{21}$ & - & 4.700000000e-01 \\
$\Delta g_{12}$ & $\si{\joule\per\mole}$ & 4.612441600e+03 & $\Delta g_{21}$ & $\si{\joule\per\mole}$ & -4.922057600e+03 \\
...
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/abs/abs_Acetone_ionic_liquid_[EMIM]+[(CF3SO2)2N]-_NrtlFixedDg_1.pdf}}
\end{figure}
%
...
The mean absolute percentage error (MAPE) between the experimental and calculated data results in 0.71\%.
\FloatBarrier
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
$\Delta u_{12}$ & $\si{\joule\per\mole}$ & -1.393857760e+03 & $\Delta u_{21}$ & $\si{\joule\per\mole}$ & 1.393857760e+03 \\
$r_{1}$ & - & 2.573500000e+00 & $r_{2}$ & - & 9.890000000e+00 \\
$q_{1}$ & - & 2.336000000e+00 & $q_{2}$ & - & 8.780000000e+00 \\
$z$ & - & 1.000000000e+01 & & &  \\
...
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/abs/abs_Acetone_ionic_liquid_[EMIM]+[(CF3SO2)2N]-_UniquacFixedDu_1.pdf}}
\end{figure}
%
...
The mean absolute percentage error (MAPE) between the experimental and calculated data results in 0.79\%.
\FloatBarrier
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
$\Delta u_{12}$ & $\si{\joule\per\mole}$ & -1.393900000e+03 & $\Delta u_{21}$ & $\si{\joule\per\mole}$ & 1.393900000e+03 \\
$r_{1}$ & - & 2.573500000e+00 & $r_{2}$ & - & 9.890000000e+00 \\
$q_{1}$ & - & 2.336000000e+00 & $q_{2}$ & - & 8.780000000e+00 \\
$z$ & - & 1.000000000e+01 & & &  \\
...
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/abs/abs_Acetone_ionic_liquid_[EMIM]+[(CF3SO2)2N]-_UniquacFixedDu_2.pdf}}
\end{figure}
%
...
The mean absolute percentage error (MAPE) between the experimental and calculated data results in 9.49\%.
\FloatBarrier
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
$\Delta\lambda_{12}$ & $\si{\joule\per\mole}$ & -2.864115360e+02 & $\Delta\lambda_{21}$ & $\si{\joule\per\mole}$ & -2.185052160e+03 \\
$v_1$ & $\si{\cubic\meter\per\mole}$ & 7.404000000e+01 & $v_2$ & $\si{\cubic\meter\per\mole}$ & 2.445800000e+02 \\
...
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/abs/abs_Acetone_ionic_liquid_[EMIM]+[(CF3SO2)2N]-_WilsonFixedDl_1.pdf}}
\end{figure}
%
...
The mean absolute percentage error (MAPE) between the experimental and calculated data results in 0.58\%.
\FloatBarrier
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
