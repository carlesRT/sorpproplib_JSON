%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Chapter 'Absorption - R-32 - lubricant BAB15'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
$T_\mathrm{crit,1}$ & $\si{\kelvin}$ & 3.512550000e+02 & $T_\mathrm{crit,2}$ & $\si{\kelvin}$ & 7.633500000e+02 \\
$p_\mathrm{crit,1}$ & $\si{\pascal}$ & 5.782000000e+06 & $p_\mathrm{crit,2}$ & $\si{\pascal}$ & 1.199000000e+06 \\
$\omega_{1}$ & - & 2.768000000e-01 & $\omega_{2}$ & - & 7.160750000e-01 \\
$\kappa_{1,1}$ & - & -4.990000000e-02 & $\kappa_{1,2}$ & - & -1.331000000e-01 \\
...
$k_{12}$ & - & 1.339000000e-01 & $m$ & - & 0.000000000e+00 \\
...
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/abs/abs_R-32_lubricant_BAB15_MixingRule_1.pdf}}
\end{figure}
%
...
The mean absolute percentage error (MAPE) between the experimental and calculated data results in 4.96\%.
\FloatBarrier
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
