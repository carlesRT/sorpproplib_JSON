%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Chapter 'Absorption - R-22 - lubricant AB32'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
$T_\mathrm{crit,1}$ & $\si{\kelvin}$ & 3.691700000e+02 & $T_\mathrm{crit,2}$ & $\si{\kelvin}$ & 8.570000000e+02 \\
$p_\mathrm{crit,1}$ & $\si{\pascal}$ & 4.978000000e+06 & $p_\mathrm{crit,2}$ & $\si{\pascal}$ & 1.015000000e+06 \\
$\omega_{1}$ & - & 0.000000000e+00 & $\omega_{2}$ & - & 0.000000000e+00 \\
$\kappa_{1,1}$ & - & 0.000000000e+00 & $\kappa_{1,2}$ & - & 0.000000000e+00 \\
$\beta_{0,1}$ & - & 1.001100000e+00 & $\beta_{0,2}$ & - & 1.000000000e+00 \\
$\beta_{1,1}$ & - & 4.329500000e-01 & $\beta_{1,2}$ & - & 8.920000000e-01 \\
$\beta_{2,1}$ & - & -6.214000000e-02 & $\beta_{2,2}$ & - & 0.000000000e+00 \\
$\beta_{3,1}$ & - & 1.500000000e-02 & $\beta_{3,2}$ & - & 0.000000000e+00 \\
$k_{12}$ & - & 0.000000000e+00 & $m$ & - & -3.950000000e-02 \\
$l_{12}$ & - & 5.690000000e-02 & $l_{21}$ & - & 6.940000000e-02 \\
$t$ & - & 3.290000000e+00 & & & \\
