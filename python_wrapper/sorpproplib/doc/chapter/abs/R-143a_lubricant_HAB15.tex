%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Chapter 'Absorption - R-143a - lubricant HAB15'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Lubricant HAB15}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
$T_\mathrm{crit,1}$ & $\si{\kelvin}$ & 3.462000000e+02 & $T_\mathrm{crit,2}$ & $\si{\kelvin}$ & 7.550000000e+02 \\
$p_\mathrm{crit,1}$ & $\si{\pascal}$ & 3.759000000e+06 & $p_\mathrm{crit,2}$ & $\si{\pascal}$ & 1.145000000e+06 \\
...
$\beta_{1,1}$ & - & 4.587400000e-01 & $\beta_{1,2}$ & - & 9.500000000e-01 \\
$\beta_{2,1}$ & - & -4.846000000e-02 & $\beta_{2,2}$ & - & 0.000000000e+00 \\
$\beta_{3,1}$ & - & -1.430000000e-02 & $\beta_{3,2}$ & - & 0.000000000e+00 \\
$k_{12}$ & - & 0.000000000e+00 & $m$ & - & -9.000000000e-02 \\
$l_{12}$ & - & 5.800000000e-02 & $l_{21}$ & - & 9.040000000e-02 \\
$t$ & - & -3.680000000e+00 & & & \\
