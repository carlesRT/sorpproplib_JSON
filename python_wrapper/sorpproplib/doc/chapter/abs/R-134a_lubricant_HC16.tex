%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Chapter 'Absorption - R-134a - lubricant HC16'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Lubricant HC16}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
$T_\mathrm{crit,1}$ & $\si{\kelvin}$ & 3.742100000e+02 & $T_\mathrm{crit,2}$ & $\si{\kelvin}$ & 7.170000000e+02 \\
$p_\mathrm{crit,1}$ & $\si{\pascal}$ & 4.059000000e+06 & $p_\mathrm{crit,2}$ & $\si{\pascal}$ & 1.419000000e+06 \\
...
$\beta_{1,1}$ & - & 5.053200000e-01 & $\beta_{1,2}$ & - & 7.310000000e-01 \\
$\beta_{2,1}$ & - & -4.983000000e-02 & $\beta_{2,2}$ & - & 0.000000000e+00 \\
$\beta_{3,1}$ & - & 0.000000000e+00 & $\beta_{3,2}$ & - & 0.000000000e+00 \\
$k_{12}$ & - & 0.000000000e+00 & $m$ & - & -1.630000000e-01 \\
$l_{12}$ & - & 9.280000000e-02 & $l_{21}$ & - & 1.074000000e-01 \\
$t$ & - & 4.190000000e+00 & & & \\
...
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/abs/abs_R-134a_lubricant_HC16_MixingRule_1.pdf}}
\end{figure}
%
...
The mean absolute percentage error (MAPE) between the experimental and calculated data results in 85.4\%.
\FloatBarrier
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
