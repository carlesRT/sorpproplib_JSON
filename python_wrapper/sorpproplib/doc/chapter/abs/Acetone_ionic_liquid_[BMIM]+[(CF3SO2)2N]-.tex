%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Chapter 'Absorption - Acetone - ionic liquid [BMIM]+[(CF3SO2)2N]-'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
$\Delta g_{12}$ & $\si{\joule\per\mole}$ & 4.093876640e+03 & $\Delta g_{21}$ & $\si{\joule\per\mole}$ & -5.089417600e+03 \\
...
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/abs/abs_Acetone_ionic_liquid_[BMIM]+[(CF3SO2)2N]-_NrtlFixedDg_1.pdf}}
\end{figure}
%
...
The mean absolute percentage error (MAPE) between the experimental and calculated data results in 0.9\%.
\FloatBarrier
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
$\Delta u_{12}$ & $\si{\joule\per\mole}$ & -1.368795600e+03 & $\Delta u_{21}$ & $\si{\joule\per\mole}$ & 1.368795600e+03 \\
$r_{1}$ & - & 2.573500000e+00 & $r_{2}$ & - & 1.116000000e+01 \\
$q_{1}$ & - & 2.336000000e+00 & $q_{2}$ & - & 1.020000000e+01 \\
$z$ & - & 1.000000000e+01 & & &  \\
...
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/abs/abs_Acetone_ionic_liquid_[BMIM]+[(CF3SO2)2N]-_UniquacFixedDu_1.pdf}}
\end{figure}
%
...
The mean absolute percentage error (MAPE) between the experimental and calculated data results in 0.77\%.
\FloatBarrier
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
$\Delta u_{12}$ & $\si{\joule\per\mole}$ & -1.368800000e+03 & $\Delta u_{21}$ & $\si{\joule\per\mole}$ & 1.368800000e+03 \\
$r_{1}$ & - & 2.573500000e+00 & $r_{2}$ & - & 1.116000000e+01 \\
$q_{1}$ & - & 2.336000000e+00 & $q_{2}$ & - & 1.020000000e+01 \\
$z$ & - & 1.000000000e+01 & & &  \\
...
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/abs/abs_Acetone_ionic_liquid_[BMIM]+[(CF3SO2)2N]-_UniquacFixedDu_2.pdf}}
\end{figure}
%
...
The mean absolute percentage error (MAPE) between the experimental and calculated data results in 1.06\%.
\FloatBarrier
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
$\Delta\lambda_{12}$ & $\si{\joule\per\mole}$ & -2.000412240e+02 & $\Delta\lambda_{21}$ & $\si{\joule\per\mole}$ & -2.410360560e+03 \\
$v_1$ & $\si{\cubic\meter\per\mole}$ & 7.404000000e+01 & $v_2$ & $\si{\cubic\meter\per\mole}$ & 2.917100000e+02 \\
...
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/abs/abs_Acetone_ionic_liquid_[BMIM]+[(CF3SO2)2N]-_WilsonFixedDl_1.pdf}}
\end{figure}
%
