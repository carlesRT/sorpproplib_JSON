%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Chapter 'Absorption - Hexane - inoic liquid [EMIM]+[(CF3SO2)2N]-'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
$a_{12}$ & $\si{\joule\per\mole}$ & 1.500340000e+04 & $a_{21}$ & $\si{\joule\per\mole}$ & 6.107000000e+02 \\
$b_{12}$ & $\si{\joule\per\mole\per\kelvin}$ & 2.803000000e+01 & $b_{21}$ & $\si{\joule\per\mole\per\kelvin}$ & 1.285000000e+01 \\
...
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/abs/abs_Hexane_inoic_liquid_[EMIM]+[(CF3SO2)2N]-_NrtlTemperatureDg_1.pdf}}
\end{figure}
%
...
The mean absolute percentage error (MAPE) between the experimental and calculated data results in 50.53\%.
\FloatBarrier
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
