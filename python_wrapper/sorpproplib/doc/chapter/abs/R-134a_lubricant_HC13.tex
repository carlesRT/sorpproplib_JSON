%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Chapter 'Absorption - R-134a - lubricant HC13'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Lubricant HC13}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
$T_\mathrm{crit,1}$ & $\si{\kelvin}$ & 3.742100000e+02 & $T_\mathrm{crit,2}$ & $\si{\kelvin}$ & 6.760000000e+02 \\
$p_\mathrm{crit,1}$ & $\si{\pascal}$ & 4.059000000e+06 & $p_\mathrm{crit,2}$ & $\si{\pascal}$ & 1.720000000e+06 \\
...
$\beta_{1,1}$ & - & 5.053200000e-01 & $\beta_{1,2}$ & - & 7.900000000e-01 \\
$\beta_{2,1}$ & - & -4.983000000e-02 & $\beta_{2,2}$ & - & 0.000000000e+00 \\
$\beta_{3,1}$ & - & 0.000000000e+00 & $\beta_{3,2}$ & - & 0.000000000e+00 \\
$k_{12}$ & - & 0.000000000e+00 & $m$ & - & -1.734000000e-01 \\
$l_{12}$ & - & 8.590000000e-02 & $l_{21}$ & - & 1.068000000e-01 \\
$t$ & - & 0.000000000e+00 & & & \\
