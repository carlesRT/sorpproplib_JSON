%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Chapter 'Absorption - R-134a - lubricant BAB15'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
$T_\mathrm{crit,1}$ & $\si{\kelvin}$ & 3.742100000e+02 & $T_\mathrm{crit,2}$ & $\si{\kelvin}$ & 7.633500000e+02 \\
$p_\mathrm{crit,1}$ & $\si{\pascal}$ & 4.059300000e+06 & $p_\mathrm{crit,2}$ & $\si{\pascal}$ & 1.199000000e+06 \\
$\omega_{1}$ & - & 3.268400000e-01 & $\omega_{2}$ & - & 7.160750000e-01 \\
$\kappa_{1,1}$ & - & -7.700000000e-03 & $\kappa_{1,2}$ & - & -1.331000000e-01 \\
...
$k_{12}$ & - & 1.496000000e-01 & $m$ & - & 0.000000000e+00 \\
...
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/abs/abs_R-134a_lubricant_BAB15_MixingRule_1.pdf}}
\end{figure}
%
...
The mean absolute percentage error (MAPE) between the experimental and calculated data results in 7.78\%.
\FloatBarrier
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
