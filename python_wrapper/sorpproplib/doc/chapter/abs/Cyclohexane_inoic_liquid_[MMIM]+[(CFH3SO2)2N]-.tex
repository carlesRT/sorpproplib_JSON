%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Chapter 'Absorption - Cyclohexane - inoic liquid [MMIM]+[(CFH3SO2)2N]-'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Inoic liquid [MMIM]+[(CFH3SO2)2N]-}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
$a_{12}$ & $\si{\joule\per\mole}$ & 3.748100000e+03 & $a_{21}$ & $\si{\joule\per\mole}$ & 7.324900000e+03 \\
$b_{12}$ & $\si{\joule\per\mole\per\kelvin}$ & -2.534000000e+01 & $b_{21}$ & $\si{\joule\per\mole\per\kelvin}$ & -1.332000000e+01 \\
...
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/abs/abs_Cyclohexane_inoic_liquid_[MMIM]+[(CFH3SO2)2N]-_NrtlTemperatureDg_1.pdf}}
\end{figure}
%
...
The mean absolute percentage error (MAPE) between the experimental and calculated data results in 55.75\%.
\FloatBarrier
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
