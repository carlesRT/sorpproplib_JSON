%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Chapter 'Absorption - Benzene - inoic liquid [EMIM]+[(CF3SO2)2N]-'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
$a_{12}$ & $\si{\joule\per\mole}$ & 4.512030000e+04 & $a_{21}$ & $\si{\joule\per\mole}$ & 8.422000000e+02 \\
$b_{12}$ & $\si{\joule\per\mole\per\kelvin}$ & -4.537000000e+01 & $b_{21}$ & $\si{\joule\per\mole\per\kelvin}$ & -3.320000000e+00 \\
...
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/abs/abs_Benzene_inoic_liquid_[EMIM]+[(CF3SO2)2N]-_NrtlTemperatureDg_1.pdf}}
\end{figure}
%
...
The mean absolute percentage error (MAPE) between the experimental and calculated data results in 72.92\%.
\FloatBarrier
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
