%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Chapter 'Absorption - R-134a - lubricant HC20'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Lubricant HC20}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
$T_\mathrm{crit,1}$ & $\si{\kelvin}$ & 3.742100000e+02 & $T_\mathrm{crit,2}$ & $\si{\kelvin}$ & 7.670000000e+02 \\
$p_\mathrm{crit,1}$ & $\si{\pascal}$ & 4.059000000e+06 & $p_\mathrm{crit,2}$ & $\si{\pascal}$ & 1.115000000e+06 \\
...
$\beta_{1,1}$ & - & 5.053200000e-01 & $\beta_{1,2}$ & - & 1.076000000e+00 \\
$\beta_{2,1}$ & - & -4.983000000e-02 & $\beta_{2,2}$ & - & 0.000000000e+00 \\
$\beta_{3,1}$ & - & 0.000000000e+00 & $\beta_{3,2}$ & - & 0.000000000e+00 \\
$k_{12}$ & - & 0.000000000e+00 & $m$ & - & -1.536000000e-01 \\
$l_{12}$ & - & 7.820000000e-02 & $l_{21}$ & - & 1.029000000e-01 \\
$t$ & - & 0.000000000e+00 & & & \\
