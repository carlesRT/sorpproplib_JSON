%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Chapter 'Absorption - Water - ionic liquid [MMIM]+[(CH3)2PO4]-'
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
$\Delta u_{12}$ & $\si{\joule\per\mole}$ & -2.949300000e+03 & $\Delta u_{21}$ & $\si{\joule\per\mole}$ & -3.130100000e+03 \\
$r_{1}$ & - & 9.200000000e-01 & $r_{2}$ & - & 7.162000000e+00 \\
$q_{1}$ & - & 1.400000000e+00 & $q_{2}$ & - & 5.844000000e+00 \\
$z$ & - & 1.000000000e+01 & & &  \\
...
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/abs/abs_Water_ionic_liquid_[MMIM]+[(CH3)2PO4]-_UniquacFixedDu_1.pdf}}
\end{figure}
%
...
The mean absolute percentage error (MAPE) between the experimental and calculated data results in 7.68\%.
\FloatBarrier
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
