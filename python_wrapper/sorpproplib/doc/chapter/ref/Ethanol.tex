...
\textbf{ID:} & 1 \\
\textbf{Reference:} & Schroeder, J. A.; Penoncello, S. G.; Schroeder, J. S. (2014): A Fundamental Equation of State for Ethanol. In: Journal of Physical and Chemical Reference Data 43 (4), S. 43102. DOI: 10.1063/1.4895394. \\
\textbf{Comment:} & None \\
...
flag & - & 1.000000000e+00 & $b_4$ & - & 1.100000000e+00 \\
$T_\mathrm{crit}$ & $\si{\kelvin}$ & 5.147100000e+02 & $a_5$ & - & -1.654590000e+01 \\
$\rho_\mathrm{ref}$ & $\si{\kilogram\per\cubic\meter}$ & 2.731951000e+02 & $b_5$ & - & 1.500000000e+00 \\
$a_1$ & - & 1.000000000e+00 & $a_6$ & - & 3.642940000e+00 \\
$b_1$ & - & 0.000000000e+00 & $b_6$ & - & 3.300000000e+00 \\
$a_2$ & - & 9.009210000e+00 & $a_7$ & - & 0.000000000e+00 \\
$b_2$ & - & 5.000000000e-01 & $b_7$ & - & 0.000000000e+00 \\
$a_3$ & - & -2.316680000e+01 & $a_8$ & - & 0.000000000e+00 \\
$b_3$ & - & 8.000000000e-01 & $b_8$ & - & 0.000000000e+00 \\
$a_4$ & - & 3.090920000e+01 & & & \\
...
\textbf{Validity:}
\newline
Equation is approximately valid for $159.0 \si{\kelvin} \leq T \leq 514.71 \si{\kelvin}$.
\newline

\textbf{Visualization:}
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_Ethanol_SaturatedLiquidDensity_EoS1_1.pdf}}
\end{figure}
%
...
$T_\mathrm{crit}$ & $\si{\kelvin}$ & 5.139000000e+02 & $a_5$ & - & -1.593705839e+00 \\
$\rho_\mathrm{ref}$ & $\si{\kilogram\per\cubic\meter}$ & 2.760000000e+02 & $b_5$ & - & 1.333333333e+00 \\
$a_1$ & - & 1.000000000e+00 & $a_6$ & - & 0.000000000e+00 \\
$b_1$ & - & 0.000000000e+00 & $b_6$ & - & 0.000000000e+00 \\
$a_2$ & - & 2.732186131e+00 & $a_7$ & - & 0.000000000e+00 \\
$b_2$ & - & 3.500000000e-01 & $b_7$ & - & 0.000000000e+00 \\
$a_3$ & - & -1.504979927e+00 & $a_8$ & - & 0.000000000e+00 \\
...
\textbf{Validity:}
\newline
Equation is approximately valid for $159.0 \si{\kelvin} \leq T \leq 513.9 \si{\kelvin}$.
\newline

\textbf{Visualization:}
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_Ethanol_SaturatedLiquidDensity_EoS1_2.pdf}}
\end{figure}
%
...
$a$ & - & 5.246770000e+00 & $c$ & $\si{\kelvin}$  & -4.642400000e+01 \\
$b$ & $\si{\kelvin}$ & 1.598673000e+03 & & & \\

\addlinespace\end{longtable}

\textbf{Validity:}
\newline
Equation is approximately valid for $292.77 \si{\kelvin} \leq T \leq 366.63 \si{\kelvin}$.
\newline

\textbf{Visualization:}
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_Ethanol_VaporPressure_Antoine_1.pdf}}
\end{figure}
%
...
$a$ & - & 4.925310000e+00 & $c$ & $\si{\kelvin}$  & -6.181900000e+01 \\
$b$ & $\si{\kelvin}$ & 1.432526000e+03 & & & \\

\addlinespace\end{longtable}

\textbf{Validity:}
\newline
Equation is approximately valid for $364.8 \si{\kelvin} \leq T \leq 513.91 \si{\kelvin}$.
\newline

\textbf{Visualization:}
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_Ethanol_VaporPressure_Antoine_2.pdf}}
\end{figure}
%
...
$a$ & - & 5.372290000e+00 & $c$ & $\si{\kelvin}$  & -4.019100000e+01 \\
$b$ & $\si{\kelvin}$ & 1.670409000e+03 & & & \\

\addlinespace\end{longtable}

\textbf{Validity:}
\newline
Equation is approximately valid for $273.0 \si{\kelvin} \leq T \leq 351.7 \si{\kelvin}$.
\newline

\textbf{Visualization:}
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_Ethanol_VaporPressure_Antoine_3.pdf}}
\end{figure}
%
...
$T_\mathrm{crit}$ & $\si{\kelvin}$ & 5.147100000e+02 & $a_4$ & - & 5.313600000e+01 \\
$p_\mathrm{crit}$ & $\si{\pascal}$ & 6.268000000e+06 & $b_4$ & - & 3.700000000e+00 \\
$a_1$ & - & -8.941610000e+00 & $a_5$ & - & 0.000000000e+00 \\
$b_1$ & - & 1.000000000e+00 & $b_5$ & - & 0.000000000e+00 \\
$a_2$ & - & 1.617610000e+00 & $a_6$ & - & 0.000000000e+00 \\
$b_2$ & - & 1.500000000e+00 & $b_6$ & - & 0.000000000e+00 \\
$a_3$ & - & -5.114280000e+01 & $a_7$ & - & 0.000000000e+00 \\
$b_3$ & - & 3.400000000e+00 & $b_7$ & - & 0.000000000e+00 \\
...
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_Ethanol_VaporPressure_EoS1_1.pdf}}
\end{figure}
%
...
$T_\mathrm{crit}$ & $\si{\kelvin}$ & 5.139000000e+02 & $a_4$ & - & -2.598600000e-01 \\
$p_\mathrm{crit}$ & $\si{\pascal}$ & 6.148000000e+06 & $b_4$ & - & 5.000000000e+00 \\
$a_1$ & - & -8.338010000e+00 & $a_5$ & - & 0.000000000e+00 \\
$b_1$ & - & 1.000000000e+00 & $b_5$ & - & 0.000000000e+00 \\
$a_2$ & - & 8.719000000e-02 & $a_6$ & - & 0.000000000e+00 \\
$b_2$ & - & 1.500000000e+00 & $b_6$ & - & 0.000000000e+00 \\
$a_3$ & - & -3.305780000e+00 & $a_7$ & - & 0.000000000e+00 \\
...
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_Ethanol_VaporPressure_EoS1_2.pdf}}
\end{figure}
%
...
$T_\mathrm{crit}$ & $\si{\kelvin}$ & 5.147100000e+02 & $\beta_1$ & - & 0.000000000e+00 \\
$p_\mathrm{crit}$ & $\si{\pascal}$ & 6.268000000e+06 & $\beta_2$ & - & 0.000000000e+00 \\
$\omega$ & - & 6.460000000e-01 & $\beta_3$ & - & 0.000000000e+00 \\
...
\textbf{Validity:}
\newline
Equation is approximately valid for $182.85 \si{\kelvin} \leq T \leq 437.5035 \si{\kelvin}$.
\newline

\textbf{Visualization:}
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_Ethanol_VaporPressure_EoSCubic_1.pdf}}
\end{figure}
%
...
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_Ethanol_VaporPressure_EoSCubic_2.pdf}}
\end{figure}
%
