...
\textbf{ID:} & 1 \\
\textbf{Reference:} & Lemmon, Eric W.; Jacobsen, Richard T. (2000): An International Standard Formulation for the Thermodynamic Properties of 1,1,1-Trifluoroethane (HFC-143a) for Temperatures From 161 to 450 K and Pressures to 50 MPa. In: Journal of Physical and Chemical Reference Data 29 (4), S. 521–552. DOI: 10.1063/1.1318909. \\
\textbf{Comment:} & None \\
...
flag & - & 1.000000000e+00 & $b_4$ & - & 2.666666667e+00 \\
$T_\mathrm{crit}$ & $\si{\kelvin}$ & 3.458570000e+02 & $a_5$ & - & 0.000000000e+00 \\
$\rho_\mathrm{ref}$ & $\si{\kilogram\per\cubic\meter}$ & 4.309949380e+02 & $b_5$ & - & 0.000000000e+00 \\
$a_1$ & - & 1.000000000e+00 & $a_6$ & - & 0.000000000e+00 \\
$b_1$ & - & 0.000000000e+00 & $b_6$ & - & 0.000000000e+00 \\
$a_2$ & - & 1.795000000e+00 & $a_7$ & - & 0.000000000e+00 \\
$b_2$ & - & 3.333333333e-01 & $b_7$ & - & 0.000000000e+00 \\
$a_3$ & - & 8.709000000e-01 & $a_8$ & - & 0.000000000e+00 \\
...
\textbf{Validity:}
\newline
Equation is approximately valid for $161.34 \si{\kelvin} \leq T \leq 345.857 \si{\kelvin}$.
\newline

\textbf{Visualization:}
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_R-143a_SaturatedLiquidDensity_EoS1_1.pdf}}
\end{figure}
%
...
$T_\mathrm{crit}$ & $\si{\kelvin}$ & 3.458600000e+02 & $a_5$ & - & 5.060540603e-01 \\
$\rho_\mathrm{ref}$ & $\si{\kilogram\per\cubic\meter}$ & 4.310000000e+02 & $b_5$ & - & 1.333333333e+00 \\
$a_1$ & - & 1.000000000e+00 & $a_6$ & - & 0.000000000e+00 \\
$b_1$ & - & 0.000000000e+00 & $b_6$ & - & 0.000000000e+00 \\
$a_2$ & - & 2.064521114e+00 & $a_7$ & - & 0.000000000e+00 \\
$b_2$ & - & 3.500000000e-01 & $b_7$ & - & 0.000000000e+00 \\
$a_3$ & - & 3.698689095e-01 & $a_8$ & - & 0.000000000e+00 \\
$b_3$ & - & 6.666666667e-01 & $b_8$ & - & 0.000000000e+00 \\
$a_4$ & - & -6.395081207e-02 & & & \\
...
\textbf{Validity:}
\newline
Equation is approximately valid for $161.34 \si{\kelvin} \leq T \leq 345.86 \si{\kelvin}$.
\newline

\textbf{Visualization:}
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_R-143a_SaturatedLiquidDensity_EoS1_2.pdf}}
\end{figure}
%
...
$a$ & - & 4.024230000e+00 & $c$ & $\si{\kelvin}$  & -3.009300000e+01 \\
$b$ & $\si{\kelvin}$ & 7.866450000e+02 & & & \\

\addlinespace\end{longtable}

\textbf{Validity:}
\newline
Equation is approximately valid for $173.6 \si{\kelvin} \leq T \leq 225.78 \si{\kelvin}$.
\newline

\textbf{Visualization:}
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_R-143a_VaporPressure_Antoine_1.pdf}}
\end{figure}
%
...
$T_\mathrm{crit}$ & $\si{\kelvin}$ & 3.458570000e+02 & $a_4$ & - & -2.053200000e+00 \\
$p_\mathrm{crit}$ & $\si{\pascal}$ & 3.761000000e+06 & $b_4$ & - & 3.500000000e+00 \\
$a_1$ & - & -7.352600000e+00 & $a_5$ & - & -1.735400000e+00 \\
$b_1$ & - & 1.000000000e+00 & $b_5$ & - & 5.500000000e+00 \\
$a_2$ & - & 1.916200000e+00 & $a_6$ & - & 0.000000000e+00 \\
$b_2$ & - & 1.500000000e+00 & $b_6$ & - & 0.000000000e+00 \\
$a_3$ & - & -1.220300000e+00 & $a_7$ & - & 0.000000000e+00 \\
...
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_R-143a_VaporPressure_EoS1_1.pdf}}
\end{figure}
%
...
$T_\mathrm{crit}$ & $\si{\kelvin}$ & 3.458600000e+02 & $a_4$ & - & -2.984130000e+00 \\
$p_\mathrm{crit}$ & $\si{\pascal}$ & 3.762000000e+06 & $b_4$ & - & 5.000000000e+00 \\
$a_1$ & - & -7.359950000e+00 & $a_5$ & - & 0.000000000e+00 \\
$b_1$ & - & 1.000000000e+00 & $b_5$ & - & 0.000000000e+00 \\
$a_2$ & - & 1.712030000e+00 & $a_6$ & - & 0.000000000e+00 \\
$b_2$ & - & 1.500000000e+00 & $b_6$ & - & 0.000000000e+00 \\
$a_3$ & - & -2.018790000e+00 & $a_7$ & - & 0.000000000e+00 \\
...
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_R-143a_VaporPressure_EoS1_2.pdf}}
\end{figure}
%
...
$T_\mathrm{crit}$ & $\si{\kelvin}$ & 3.458600000e+02 & $\beta_1$ & - & 0.000000000e+00 \\
$p_\mathrm{crit}$ & $\si{\pascal}$ & 3.761000000e+06 & $\beta_2$ & - & 0.000000000e+00 \\
$\omega$ & - & 2.615000000e-01 & $\beta_3$ & - & 0.000000000e+00 \\
...
\textbf{Validity:}
\newline
Equation is approximately valid for $185.541 \si{\kelvin} \leq T \leq 293.981 \si{\kelvin}$.
\newline

\textbf{Visualization:}
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_R-143a_VaporPressure_EoSCubic_1.pdf}}
\end{figure}
%
...
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_R-143a_VaporPressure_EoSCubic_2.pdf}}
\end{figure}
%
