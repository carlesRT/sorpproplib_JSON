...
$T_\mathrm{crit}$ & $\si{\kelvin}$ & 2.094800000e+02 & $a_5$ & - & 1.963675824e-01 \\
$\rho_\mathrm{ref}$ & $\si{\kilogram\per\cubic\meter}$ & 9.100000000e+02 & $b_5$ & - & 1.333333333e+00 \\
$a_1$ & - & 1.000000000e+00 & $a_6$ & - & 0.000000000e+00 \\
$b_1$ & - & 0.000000000e+00 & $b_6$ & - & 0.000000000e+00 \\
$a_2$ & - & 1.771438462e+00 & $a_7$ & - & 0.000000000e+00 \\
$b_2$ & - & 3.500000000e-01 & $b_7$ & - & 0.000000000e+00 \\
$a_3$ & - & 3.763043956e-01 & $a_8$ & - & 0.000000000e+00 \\
...
\textbf{Validity:}
\newline
Equation is approximately valid for $115.78 \si{\kelvin} \leq T \leq 209.48 \si{\kelvin}$.
\newline

\textbf{Visualization:}
%
\newline
No adsorption or absorption working pair exists, which uses refrigerant 'Krypton'. Thus, data cannot be visualized!
%
...
$a$ & - & 4.206400000e+00 & $c$ & $\si{\kelvin}$  & 8.855000000e+00 \\
$b$ & $\si{\kelvin}$ & 5.390040000e+02 & & & \\

\addlinespace\end{longtable}

\textbf{Validity:}
\newline
Equation is approximately valid for $126.68 \si{\kelvin} \leq T \leq 208.0 \si{\kelvin}$.
\newline
...
$T_\mathrm{crit}$ & $\si{\kelvin}$ & 5.200000000e+00 & $a_4$ & - & -1.300120000e+00 \\
$p_\mathrm{crit}$ & $\si{\pascal}$ & 2.270000000e+05 & $b_4$ & - & 5.000000000e+00 \\
$a_1$ & - & -5.983960000e+00 & $a_5$ & - & 0.000000000e+00 \\
$b_1$ & - & 1.000000000e+00 & $b_5$ & - & 0.000000000e+00 \\
$a_2$ & - & 1.343340000e+00 & $a_6$ & - & 0.000000000e+00 \\
$b_2$ & - & 1.500000000e+00 & $b_6$ & - & 0.000000000e+00 \\
$a_3$ & - & -6.652100000e-01 & $a_7$ & - & 0.000000000e+00 \\
...
\textbf{Validity:}
\newline
Equation is approximately valid for $115.78 \si{\kelvin} \leq T \leq 5.2 \si{\kelvin}$.
\newline
...
$T_\mathrm{crit}$ & $\si{\kelvin}$ & 2.094800000e+02 & $\beta_1$ & - & 0.000000000e+00 \\
$p_\mathrm{crit}$ & $\si{\pascal}$ & 5.525000000e+06 & $\beta_2$ & - & 0.000000000e+00 \\
$\omega$ & - & -8.940000000e-04 & $\beta_3$ & - & 0.000000000e+00 \\
...
\textbf{Validity:}
\newline
Equation is approximately valid for $133.147 \si{\kelvin} \leq T \leq 178.058 \si{\kelvin}$.
\newline
