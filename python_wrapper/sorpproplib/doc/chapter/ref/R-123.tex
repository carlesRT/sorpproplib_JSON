...
\textbf{ID:} & 1 \\
\textbf{Reference:} & Younglove, Ben A.; McLinden, Mark O. (1994): An International Standard Equation of State for the Thermodynamic Properties of Refrigerant 123 (2,2‐Dichloro‐1,1,1‐Trifluoroethane). In: Journal of Physical and Chemical Reference Data 23 (5), S. 731–779. DOI: 10.1063/1.555950. \\
\textbf{Comment:} & None \\
...
$T_\mathrm{crit}$ & $\si{\kelvin}$ & 4.568310000e+02 & $a_5$ & - & 9.536980230e-01 \\
$\rho_\mathrm{ref}$ & $\si{\kilogram\per\cubic\meter}$ & 5.500000518e+02 & $b_5$ & - & 1.333333333e+00 \\
$a_1$ & - & 1.000000000e+00 & $a_6$ & - & 0.000000000e+00 \\
$b_1$ & - & 0.000000000e+00 & $b_6$ & - & 0.000000000e+00 \\
$a_2$ & - & 2.032125410e+00 & $a_7$ & - & 0.000000000e+00 \\
$b_2$ & - & 3.550000000e-01 & $b_7$ & - & 0.000000000e+00 \\
$a_3$ & - & 6.151386150e-01 & $a_8$ & - & 0.000000000e+00 \\
...
\textbf{Validity:}
\newline
Equation is approximately valid for $166.0 \si{\kelvin} \leq T \leq 456.831 \si{\kelvin}$.
\newline

\textbf{Visualization:}
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_R-123_SaturatedLiquidDensity_EoS1_1.pdf}}
\end{figure}
%
...
$T_\mathrm{crit}$ & $\si{\kelvin}$ & 4.568310000e+02 & $a_4$ & - & -3.194718270e+00 \\
$p_\mathrm{crit}$ & $\si{\pascal}$ & 3.661800000e+06 & $b_4$ & - & 4.000000000e+00 \\
$a_1$ & - & -7.447552680e+00 & $a_5$ & - & -1.299823160e+00 \\
$b_1$ & - & 1.000000000e+00 & $b_5$ & - & 6.500000000e+00 \\
$a_2$ & - & 2.222058280e+00 & $a_6$ & - & 0.000000000e+00 \\
$b_2$ & - & 1.500000000e+00 & $b_6$ & - & 0.000000000e+00 \\
$a_3$ & - & -1.900077220e+00 & $a_7$ & - & 0.000000000e+00 \\
...
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_R-123_VaporPressure_EoS1_1.pdf}}
\end{figure}
%
...
$T_\mathrm{crit}$ & $\si{\kelvin}$ & 4.568300000e+02 & $\beta_1$ & - & 0.000000000e+00 \\
$p_\mathrm{crit}$ & $\si{\pascal}$ & 3.661800000e+06 & $\beta_2$ & - & 0.000000000e+00 \\
$\omega$ & - & 2.819200000e-01 & $\beta_3$ & - & 0.000000000e+00 \\
...
\textbf{Validity:}
\newline
Equation is approximately valid for $190.9 \si{\kelvin} \leq T \leq 388.3055 \si{\kelvin}$.
\newline

\textbf{Visualization:}
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_R-123_VaporPressure_EoSCubic_1.pdf}}
\end{figure}
%
...
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_R-123_VaporPressure_EoSCubic_2.pdf}}
\end{figure}
%
