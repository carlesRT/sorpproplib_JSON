...
$T_\mathrm{crit}$ & $\si{\kelvin}$ & 3.512600000e+02 & $a_5$ & - & 5.416509434e-01 \\
$\rho_\mathrm{ref}$ & $\si{\kilogram\per\cubic\meter}$ & 4.240000000e+02 & $b_5$ & - & 1.333333333e+00 \\
$a_1$ & - & 1.000000000e+00 & $a_6$ & - & 0.000000000e+00 \\
$b_1$ & - & 0.000000000e+00 & $b_6$ & - & 0.000000000e+00 \\
$a_2$ & - & 2.111498349e+00 & $a_7$ & - & 0.000000000e+00 \\
$b_2$ & - & 3.500000000e-01 & $b_7$ & - & 0.000000000e+00 \\
$a_3$ & - & 5.287551887e-01 & $a_8$ & - & 0.000000000e+00 \\
...
\textbf{Validity:}
\newline
Equation is approximately valid for $136.34 \si{\kelvin} \leq T \leq 351.26 \si{\kelvin}$.
\newline

\textbf{Visualization:}
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_R-32_SaturatedLiquidDensity_EoS1_1.pdf}}
\end{figure}
%
...
$a$ & - & 4.262240000e+00 & $c$ & $\si{\kelvin}$  & -2.855400000e+01 \\
$b$ & $\si{\kelvin}$ & 8.210920000e+02 & & & \\

\addlinespace\end{longtable}

\textbf{Validity:}
\newline
Equation is approximately valid for $191.19 \si{\kelvin} \leq T \leq 241.33 \si{\kelvin}$.
\newline

\textbf{Visualization:}
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_R-32_VaporPressure_Antoine_1.pdf}}
\end{figure}
%
...
\textbf{ID:} & 1 \\
\textbf{Reference:} & Weber, L. A.; Silva, A. M. (1994): Measurements of the Vapor Pressures of Difluoromethane, 1-Chloro-1,2,2,2-tetrafluoroethane, and Pentafluoroethane. In: J. Chem. Eng. Data 39 (4), S. 808–812. DOI: 10.1021/je00016a038. \\
\textbf{Comment:} & None \\
...
$T_\mathrm{crit}$ & $\si{\kelvin}$ & 3.513600000e+02 & $a_4$ & - & -2.617090000e+00 \\
$p_\mathrm{crit}$ & $\si{\pascal}$ & 5.793100000e+06 & $b_4$ & - & 5.000000000e+00 \\
$a_1$ & - & -7.461490000e+00 & $a_5$ & - & 0.000000000e+00 \\
$b_1$ & - & 1.000000000e+00 & $b_5$ & - & 0.000000000e+00 \\
$a_2$ & - & 1.736870000e+00 & $a_6$ & - & 0.000000000e+00 \\
$b_2$ & - & 1.500000000e+00 & $b_6$ & - & 0.000000000e+00 \\
$a_3$ & - & -1.986560000e+00 & $a_7$ & - & 0.000000000e+00 \\
...
\textbf{Validity:}
\newline
Equation is approximately valid for $136.34 \si{\kelvin} \leq T \leq 351.36 \si{\kelvin}$.
\newline

\textbf{Visualization:}
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_R-32_VaporPressure_EoS1_1.pdf}}
\end{figure}
%
...
$T_\mathrm{crit}$ & $\si{\kelvin}$ & 3.512600000e+02 & $a_4$ & - & -2.621470000e+00 \\
$p_\mathrm{crit}$ & $\si{\pascal}$ & 5.783000000e+06 & $b_4$ & - & 5.000000000e+00 \\
$a_1$ & - & -7.470270000e+00 & $a_5$ & - & 0.000000000e+00 \\
$b_1$ & - & 1.000000000e+00 & $b_5$ & - & 0.000000000e+00 \\
$a_2$ & - & 1.755950000e+00 & $a_6$ & - & 0.000000000e+00 \\
$b_2$ & - & 1.500000000e+00 & $b_6$ & - & 0.000000000e+00 \\
$a_3$ & - & -2.014290000e+00 & $a_7$ & - & 0.000000000e+00 \\
$b_3$ & - & 2.500000000e+00 & $b_7$ & - & 0.000000000e+00 \\
...
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_R-32_VaporPressure_EoS1_2.pdf}}
\end{figure}
%
...
$T_\mathrm{crit}$ & $\si{\kelvin}$ & 3.512600000e+02 & $\beta_1$ & - & 0.000000000e+00 \\
$p_\mathrm{crit}$ & $\si{\pascal}$ & 5.782000000e+06 & $\beta_2$ & - & 0.000000000e+00 \\
$\omega$ & - & 2.769000000e-01 & $\beta_3$ & - & 0.000000000e+00 \\
...
\textbf{Validity:}
\newline
Equation is approximately valid for $156.791 \si{\kelvin} \leq T \leq 298.571 \si{\kelvin}$.
\newline

\textbf{Visualization:}
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_R-32_VaporPressure_EoSCubic_1.pdf}}
\end{figure}
%
...
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_R-32_VaporPressure_EoSCubic_2.pdf}}
\end{figure}
%
