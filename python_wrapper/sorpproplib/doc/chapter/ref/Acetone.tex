...
$T_\mathrm{crit}$ & $\si{\kelvin}$ & 5.081000000e+02 & $a_5$ & - & 9.269839416e-01 \\
$\rho_\mathrm{ref}$ & $\si{\kilogram\per\cubic\meter}$ & 2.740000000e+02 & $b_5$ & - & 1.333333333e+00 \\
$a_1$ & - & 1.000000000e+00 & $a_6$ & - & 0.000000000e+00 \\
$b_1$ & - & 0.000000000e+00 & $b_6$ & - & 0.000000000e+00 \\
$a_2$ & - & 1.997744525e+00 & $a_7$ & - & 0.000000000e+00 \\
$b_2$ & - & 3.500000000e-01 & $b_7$ & - & 0.000000000e+00 \\
$a_3$ & - & 7.618321168e-01 & $a_8$ & - & 0.000000000e+00 \\
...
\textbf{Validity:}
\newline
Equation is approximately valid for $178.5 \si{\kelvin} \leq T \leq 508.1 \si{\kelvin}$.
\newline

\textbf{Visualization:}
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_Acetone_SaturatedLiquidDensity_EoS1_1.pdf}}
\end{figure}
%
...
$a$ & - & 4.424480000e+00 & $c$ & $\si{\kelvin}$  & -3.244500000e+01 \\
$b$ & $\si{\kelvin}$ & 1.312253000e+03 & & & \\

\addlinespace\end{longtable}

\textbf{Validity:}
\newline
Equation is approximately valid for $259.16 \si{\kelvin} \leq T \leq 507.6 \si{\kelvin}$.
\newline

\textbf{Visualization:}
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_Acetone_VaporPressure_Antoine_1.pdf}}
\end{figure}
%
...
$T_\mathrm{crit}$ & $\si{\kelvin}$ & 5.081000000e+02 & $a_4$ & - & -2.901620000e+00 \\
$p_\mathrm{crit}$ & $\si{\pascal}$ & 4.692000000e+06 & $b_4$ & - & 5.000000000e+00 \\
$a_1$ & - & -7.670330000e+00 & $a_5$ & - & 0.000000000e+00 \\
$b_1$ & - & 1.000000000e+00 & $b_5$ & - & 0.000000000e+00 \\
$a_2$ & - & 1.964690000e+00 & $a_6$ & - & 0.000000000e+00 \\
$b_2$ & - & 1.500000000e+00 & $b_6$ & - & 0.000000000e+00 \\
$a_3$ & - & -2.443800000e+00 & $a_7$ & - & 0.000000000e+00 \\
...
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_Acetone_VaporPressure_EoS1_1.pdf}}
\end{figure}
%
...
$T_\mathrm{crit}$ & $\si{\kelvin}$ & 5.081000000e+02 & $\beta_1$ & - & 0.000000000e+00 \\
$p_\mathrm{crit}$ & $\si{\pascal}$ & 4.692400000e+06 & $\beta_2$ & - & 0.000000000e+00 \\
$\omega$ & - & 3.071000000e-01 & $\beta_3$ & - & 0.000000000e+00 \\
...
\textbf{Validity:}
\newline
Equation is approximately valid for $205.275 \si{\kelvin} \leq T \leq 431.885 \si{\kelvin}$.
\newline

\textbf{Visualization:}
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_Acetone_VaporPressure_EoSCubic_1.pdf}}
\end{figure}
%
...
%
\begin{figure}[!htp]
{\noindent\includegraphics[height=10cm, keepaspectratio]{figs/ref/ref_Acetone_VaporPressure_EoSCubic_2.pdf}}
\end{figure}
%
