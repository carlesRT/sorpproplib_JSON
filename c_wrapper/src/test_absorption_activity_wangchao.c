/////////////////////////////////////////
// test_absorption_activity_wangchao.c //
/////////////////////////////////////////
#include <stdio.h>
#include <stdlib.h>
...
int main() {
	...
	//
	double isotherm_par[] = {2715, -1609, 6, 1, 1};
	...
	//
	double gamma_1 = absorption_activity_wangchao_g1_Txv1v2(T_K,
		x_molmol, -1, -1, isotherm_par);
	double p_Pa = absorption_activity_wangchao_p_Txv1v2psat(T_K,
		x_molmol, -1, -1, psat_Pa, isotherm_par);
	double x_inv_molmol = absorption_activity_wangchao_x_pTv1v2psat(
		p_Pa, T_K, -1, -1, psat_Pa, isotherm_par);

	// Print calculated values
	//
	printf("\n\n##\n##\nSelected working pair is \"PAG / R-134a\".");
	printf("\nSelected absorption equation is \"Wang & Chao\".");
