...
int main() {
	...
	double rho_l_r134a_kgm3_minus = refrigerant_r134a->rho_l_T(T_K-0.0001,
		satLiqDen_par);
	double drho_l_dT_r134a_kgm3K = refrigerant_r134a->drho_l_dT(T_K, satLiqDen_par);
