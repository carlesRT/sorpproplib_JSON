...
int main() {
	...
	double psat_water_Pa = refrigerant_p_sat_eos1(T_water_K,
		refrigerant_water_par);
	...
	double psat_r134a_2_Pa = refrigerant_p_sat_eos1(T_r134a_2_K,
		refrigerant_r134a_par);
	...
	printf("\n\nFor T = %f K and x = %f mol/mol, activity coefficient of "
		"R-134a results in gamma_1 = %f.", T_r134a_K, x_r134a_molmol,
		gamma_r134a_1);
	printf("\nFor T = %f K and x = %f mol/mol, equilibrium pressure results in "
