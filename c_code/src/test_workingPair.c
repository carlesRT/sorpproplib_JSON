...
//////////////////////////
#ifdef __unix
	#define PATH ".//data//SorpPropLib_MinimalExample.json"
#else
	#define PATH ".\\data\\SorpPropLib_MinimalExample.json"
#endif
...
void testWorkingPair_abs_con(const char *path_db, const char *wp_as,
	...
	if (workingPair != NULL) {
		...
		double X_kgkg_direct = direct_abs_con_X_pT(
			p_Pa, T_K, path_db, wp_as, wp_st, wp_rf, wp_iso, no_iso, rf_psat,
			no_p_sat, rf_rhol, no_rhol);
		double dX_dp_kgkgPa_direct = direct_abs_con_dX_dp_pT(
			p_Pa, T_K, path_db, wp_as, wp_st, wp_rf, wp_iso, no_iso, rf_psat,
			no_p_sat, rf_rhol, no_rhol);
		double dX_dT_kgkgK_direct = direct_abs_con_dX_dT_pT(
			p_Pa, T_K, path_db, wp_as, wp_st, wp_rf, wp_iso, no_iso, rf_psat,
			no_p_sat, rf_rhol, no_rhol);
		double p_Pa_inv_direct = direct_abs_con_p_XT(
			X_kgkg, T_K, path_db, wp_as, wp_st, wp_rf, wp_iso, no_iso, rf_psat,
			no_p_sat, rf_rhol, no_rhol);
		double dp_dX_Pakgkg_direct = direct_abs_con_dp_dX_XT(
			X_kgkg, T_K, path_db, wp_as, wp_st, wp_rf, wp_iso, no_iso, rf_psat,
			no_p_sat, rf_rhol, no_rhol);
		double dp_dT_Pakgkg_direct = direct_abs_con_dp_dT_XT(
			X_kgkg, T_K, path_db, wp_as, wp_st, wp_rf, wp_iso, no_iso, rf_psat,
			no_p_sat, rf_rhol, no_rhol);
		double T_K_inv_direct = direct_abs_con_T_pX(
...
int main() {
	...
	// Test working pair: Silica gel 123 / water
	//
	testWorkingPair_ads(
		PATH,
		"silicagel",
