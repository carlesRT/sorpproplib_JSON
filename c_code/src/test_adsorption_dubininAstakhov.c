...
int main() {
	...
	double p_sat_Pa = refrigerant_r134a->p_sat_T(T_K, vapPre_par,
		refrigerant_r134a);
	double dp_sat_dT_PaK = refrigerant_r134a->dp_sat_dT(T_K, vapPre_par,
		refrigerant_r134a);
	...
	//
	double W = adsorption_dubininAstakhov_W_ARho(A_Jmol, rho_kgm3,
		isotherm_par);
	...
	double dw_dp_plus_kgkgPa = adsorption_dubininAstakhov_w_pTpsatRho(
		p_Pa+0.001, T_K, p_sat_Pa, rho_kgm3, isotherm_par);
	double dw_dp_minus_kgkgPa = adsorption_dubininAstakhov_w_pTpsatRho(
		p_Pa-0.001, T_K, p_sat_Pa, rho_kgm3, isotherm_par);
	...
	//
	double piStar_molkg = adsorption_dubininAstakhov_piStar_pyxgTpsatRhoM(p_Pa,
		1, 1, 1, T_K, p_sat_Pa, rho_kgm3, 0.0441, isotherm_par);
