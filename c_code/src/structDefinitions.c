...
////////////////////////////
/*
 * These prototypes are used to create all structs in a more cleaner way. Thus,
 * function pointers can be expressed by type definition. The numbers indicate
 * the following:
 *
...
struct Refrigerant {
	...
	//
	genFunc_1_1_1 p_sat_T;
	genFunc_1_1_1 T_sat_p;
	genFunc_1_1_1 dp_sat_dT;
	...
	// functions
	//
	genFunc_1_1_0 other_p_sat_T;
	genFunc_1_1_0 other_T_sat_p;
	genFunc_1_1_0 other_dp_sat_dT;
