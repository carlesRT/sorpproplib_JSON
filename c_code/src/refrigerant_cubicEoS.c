...
////////////////////////////////////////////////
// Definition of functions: General functions //
////////////////////////////////////////////////
/*
...
//////////////////////////////////////////////////////
// Definition of function: Cubic equations of state //
//////////////////////////////////////////////////////
/*
...
void refrigerant_cubic_SRKE_parameters(double *ret_par, double T_K,
	...
	//
	double kappa = 0.48508 + 1.55171 * refrigerant_par[3] - 0.15613 *
...
void refrigerant_cubic_PRE_parameters(double *ret_par, double T_K,
	...
	// Calculate auxiliary parameters
	//
	double kappa = 0.37464 + 1.54226 * refrigerant_par[3] - 0.26992 *
		pow(refrigerant_par[3], 2);
	double alpha = pow(1 + kappa * (1 - sqrt(T_K / refrigerant_par[2])), 2);
	...
	ret_par[1] = 0.07780 * IDEAL_GAS_CONSTANT * refrigerant_par[2] /
		refrigerant_par[1];
}
...
///////////////////////////////////////////
// Definition of functions: Mixing rules //
///////////////////////////////////////////
/*
